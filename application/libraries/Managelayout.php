...
class Managelayout extends CI_Controller
{
    ...
    {	
        ...
        $simnum = $CI->cbconfig->get_device_view_type() === 'mobile' ? '2020-I10-14-1253' : '2020-ET1-14-0144';
        $return = '
        <footer class="footer">
            <div class="footer_inner_center">
                <div class="logo_img"><img src="'.base_url('/assets/images/logo_jeisys.svg').'" alt="제이시스 로고" class="img"></div>
                ...
                <div class="sns_box">
                    ...
                    <a href="https://www.instagram.com/jeisysmedical_kr/" class="sns_link sns_instagram"><img src="'.base_url('/assets/images/logo_instagram.svg').'" alt="제이시스 인스타그램" class="img"></a>
                </div>
            </div>
        </footer>';
        return $return;
