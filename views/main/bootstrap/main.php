    ...
    <div class="wrap">
        ...
        <div class="main" style="margin-top:0px;">
            ...
            <div class="quick_link01">
                ...
                <a href="https://www.instagram.com/p/CQxPrHnHxQj/?utm_source=ig_web_copy_link" target="_blank" ><img src="<?php echo base_url('/assets/images/quick_event_0707.png')?>?u=<?php echo date('Ymd')?>" alt="리니어펌 이벤트" class="img"></a>
            </div>
            ...
            <!-- 리니어펌? -->
            <a href="https://www.instagram.com/p/CQxPrHnHxQj/?utm_source=ig_web_copy_link" target="_blank" >
        ...
        $(function(){
            ...
            $(document).ready(function() {
                <?php if(element('section',$view)){?>
                    ...
                    $('html, body').animate({scrollTop : offset.top-60}, 40);
                <?php }  ?>
