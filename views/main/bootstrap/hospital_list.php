    ...
    <div class="wrap02">
        ...
        <div class="main" style="margin-top:0px;">
            <div class="quick_link01">
                ...
                <a href="https://www.instagram.com/p/CR0G1gAnV8g" target="_blank" >
                <img src="<?php echo base_url('/assets/images/quick_event_0707.jpg')?>?u=<?php echo date('Ymd')?>" alt="리니어펌 이벤트" class="img">
                </a>
            </div>
            <div class="list_wrap">
            <?php 
